...
func fillUpTablePointerToGongstruct[T models.PointerToGongstruct](
	...
	// insertion point
	case *models.Body:
		fillUpTable[models.Body](probe)
	case *models.Document:
		fillUpTable[models.Document](probe)
	case *models.Docx:
		fillUpTable[models.Docx](probe)
	case *models.File:
		fillUpTable[models.File](probe)
	case *models.Node:
		fillUpTable[models.Node](probe)
	case *models.Paragraph:
		fillUpTable[models.Paragraph](probe)
	case *models.ParagraphProperties:
		fillUpTable[models.ParagraphProperties](probe)
	case *models.ParagraphStyle:
		fillUpTable[models.ParagraphStyle](probe)
	case *models.Rune:
		fillUpTable[models.Rune](probe)
	case *models.RuneProperties:
		fillUpTable[models.RuneProperties](probe)
	case *models.Table:
		fillUpTable[models.Table](probe)
	case *models.TableColumn:
		fillUpTable[models.TableColumn](probe)
	case *models.TableProperties:
		fillUpTable[models.TableProperties](probe)
	case *models.TableRow:
		fillUpTable[models.TableRow](probe)
	case *models.TableStyle:
		fillUpTable[models.TableStyle](probe)
	case *models.Text:
