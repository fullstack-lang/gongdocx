...
import (
	...
	"github.com/fullstack-lang/gongdocx"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(gongdocx.NgDistNg, "ng-github.com-fullstack-lang-gongdocx/dist/ng-github.com-fullstack-lang-gongdocx/browser")))
