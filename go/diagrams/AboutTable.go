...
var map_DocLink_Identifier_AboutTable map[string]any = map[string]any{
...
// 	InjectionGateway["AboutTable"] = AboutTableInjection
// }

// AboutTableInjection will stage objects of database "AboutTable"
func AboutTableInjection(stage *models.StageStruct) {
