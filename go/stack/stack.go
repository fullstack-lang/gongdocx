...
import (
	...
	"github.com/fullstack-lang/gongdocx/go/fullstack"
	"github.com/fullstack-lang/gongdocx/go/models"
	"github.com/fullstack-lang/gongdocx/go/orm"
	"github.com/fullstack-lang/gongdocx/go/probe"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.StageStruct) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/fullstack-lang/gongdocx/go/models", "main")
}
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, gongdocx_go.GoModelsDir, gongdocx_go.GoDiagramsDir,
