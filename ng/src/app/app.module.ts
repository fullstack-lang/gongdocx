...
import { GongdocxspecificModule } from 'gongdocxspecific'
import { GongdocxdatamodelModule } from 'gongdocxdatamodel'
import { GongstructSelectionService } from 'gongdocx'
...
@NgModule({
  ...
  imports: [
    ...
    GongdocxModule,
    GongdocxspecificModule,
    GongdocxdatamodelModule,
  ],
  providers: [
