...
import * as gongdocx from '../../projects/gongdocx/src/public-api'

import { GongdocxspecificComponent } from '../../projects/gongdocxspecific/src/public-api'
...
export class AppComponent implements OnInit {
  ...
  gongdocx = 'Gongdocx'
  probe = 'Gongdocx Data/Model'
  view = this.gongdocx

  views: string[] = [this.gongdocx, this.probe];
